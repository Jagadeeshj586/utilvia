import { CRON_FAQS } from "@/lib/cron/cron";
import { SUBNET_FAQS } from "@/lib/subnet/calculate";
import { SVG_PREVIEW_FAQS } from "@/lib/svg-preview/svg";
import { CSS_GRADIENT_FAQS } from "@/lib/css-gradient/gradient";
import { GLASS_FAQS } from "@/lib/glassmorphism/glass";
import { SHADOW_FAQS } from "@/lib/box-shadow/shadow";
import { UNIX_TIMESTAMP_FAQS } from "@/lib/unix-timestamp/convert";
import { POMODORO_FAQS } from "@/lib/pomodoro/types";
import { BOX_BREATHING_FAQS } from "@/lib/box-breathing/types";
import { AUDIO_RECORDER_FAQS } from "@/lib/audio-recorder/recorder";
import { NUMBER_TO_WORDS_FAQS } from "@/lib/number-to-words/convert";
import { HASH_GENERATOR_FAQS } from "@/lib/hash/generate";
import { CSV_TO_JSON_FAQS } from "@/lib/csv/convert";
import { JSON_TO_CSV_FAQS } from "@/lib/json-to-csv/convert";
import { DNS_LOOKUP_FAQS } from "@/lib/dns-lookup";
import { ROBOTS_FAQS } from "@/lib/robots-txt/generate";
import { HTACCESS_FAQS } from "@/lib/htaccess/generate";
import { HTTP_STATUS_FAQS } from "@/lib/http-status/codes";
import { JSON_SCHEMA_FAQS } from "@/lib/json-schema/validate";
import { IP_LOOKUP_FAQS } from "@/lib/ip-lookup/lookup";
import { REGEX_TESTER_FAQS } from "@/lib/regex/test";
import { HTML_ENTITY_FAQS } from "@/lib/html-entity/convert";
import { MORSE_FAQS } from "@/lib/morse/convert";
import { XML_FAQS } from "@/lib/xml/format";
import { SQL_FAQS } from "@/lib/sql/format";
import { JWT_FAQS } from "@/lib/jwt/decode";
import { TEXT_DIFF_FAQS } from "@/lib/text/diff";
import { CHARACTER_COUNTER_FAQS } from "@/lib/text/character-count";
import { TTS_FAQS } from "@/lib/text-to-speech/speech";
import { CALORIE_DEFICIT_FAQS } from "@/lib/calorie/calculate";
import { COMPOUND_INTEREST_FAQS } from "@/lib/compound-interest/calculate";
import { TIMEZONE_FAQS } from "@/lib/timezone/convert";
import { BINARY_CONVERTER_FAQS } from "@/lib/binary/convert";
import { DISCOUNT_FAQS } from "@/lib/calculators/discount";
import { EPF_FAQS } from "@/lib/epf/calculate";
import { PPF_FAQS } from "@/lib/ppf/calculate";
import { GRATUITY_FAQS } from "@/lib/gratuity/calculate";
import { LTA_FAQS } from "@/lib/lta/calculate";
import { LEAVE_ENCASHMENT_FAQS, LEAVE_ENCASHMENT_RULES } from "@/lib/leave-encashment/calculate";
import { CAGR_FAQS, CAGR_RULES } from "@/lib/cagr/calculate";
import { ADVANCE_TAX_FAQS, ADVANCE_TAX_RULES } from "@/lib/advance-tax/calculate";
import { PROFESSIONAL_TAX_FAQS, PT_RULES } from "@/lib/professional-tax/calculate";
import { PAY_STUB_FAQS, PAY_STUB_RULES } from "@/lib/pay-stub/calculate";
import { HOURLY_SALARY_FAQS } from "@/lib/hourly-salary/calculate";
import { INFLATION_FAQS } from "@/lib/inflation/calculate";
import { SIP_FAQS } from "@/lib/calculators/sip";
import { COLOR_PICKER_FAQS } from "@/lib/color/faqs";
import { COLOR_CONTRAST_FAQS } from "@/lib/color/contrast";
import { COLOR_PALETTE_FAQS } from "@/lib/color-palette/generate";
import { MARKDOWN_TO_HTML_FAQS } from "@/lib/markdown/convert";
import { MD_TABLE_FAQS } from "@/lib/markdown-table/generate";
import { FAVICON_FAQS } from "@/lib/favicon/generate";
import { SVG_TO_PNG_FAQS } from "@/lib/svg-to-png/convert";
import { ASPECT_RATIO_FAQS } from "@/lib/aspect-ratio/calculate";
import { RANDOM_NUMBER_FAQS } from "@/lib/random/generate";
import { URL_ENCODER_FAQS } from "@/lib/url/encode";
import { UNIT_CONVERTER_FAQS } from "@/lib/converters/units";
import { PASSWORD_FAQS } from "@/lib/security/password";
import { GPA_FAQS } from "@/lib/gpa/calculate";
import { DAYS_BETWEEN_FAQS } from "@/lib/days-between/calculate";
import { ROMAN_FAQS } from "@/lib/roman/convert";
import { LEAP_YEAR_FAQS } from "@/lib/leap-year/check";
import { PAYCHECK_FAQS } from "@/lib/paycheck/calculate";
import { MORTGAGE_FAQS } from "@/lib/mortgage/calculate";
import { LOAN_ELIGIBILITY_FAQS } from "@/lib/loan-eligibility/calculate";
import { LABOUR_SALARY_FAQS } from "@/lib/labour-salary/calculate";
import { CURRENCY_FAQS } from "@/lib/currency/convert";
import { CRYPTO_MARKET_FAQS } from "@/lib/crypto-markets";
import { CAPITAL_GAINS_FAQS } from "@/lib/capital-gains/calculate";
import { RD_FAQS, RD_RULES } from "@/lib/rd/calculate";
import { NPS_FAQS, NPS_RULES } from "@/lib/nps/calculate";
import { K401_FAQS, K401_RULES } from "@/lib/us-401k/calculate";
import { ROTH_COMPARE_FAQS, ROTH_COMPARE_RULES } from "@/lib/roth-compare/calculate";
import { BONUS_FAQS, BONUS_RULES } from "@/lib/bonus/calculate";
import { ESI_FAQS, ESI_RULES } from "@/lib/esi/calculate";
import { SWP_FAQS, SWP_RULES } from "@/lib/swp/calculate";
import { DIVIDEND_FAQS, DIVIDEND_RULES } from "@/lib/dividend-yield/calculate";
import { GST_THRESHOLD_FAQS, GST_THRESHOLD_RULES } from "@/lib/gst-threshold/calculate";
import { HSA_FAQS, HSA_RULES } from "@/lib/hsa/calculate";
import { RENT_RECEIPT_FAQS, RENT_RECEIPT_RULES } from "@/lib/rent-receipt/generate";
import { EMPLOYMENT_COMPARE_FAQS } from "@/lib/employment-compare/calculate";
import { SELF_EMPLOYMENT_FAQS } from "@/lib/self-employment/calculate";
...
export type { ToolAbout } from "@/lib/tools/tool-content";
...
function tool(input: ToolInput): ToolDefinition {
  ...
  return {
    ...
    longDescription: input.longDescription ?? `${input.short} Runs in your browser like WorkUtilities - no signup, instant results.`,
    ...
    privacy,
    fileUpload,
    about: input.about ?? buildToolAbout(contentInput),
    faqs: input.faqs?.length
      ? input.faqs
      : [
          ...buildDefaultFaqs(contentInput),
          { question: "Is Utilvia free?", answer: "Yes. Essential tools are free and do not require an account." },
        ],
...
const RAW: ToolInput[] = [
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: RD_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "fd-calculator" },
      { category: "finance", slug: "sip-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: NPS_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "ppf-calculator" },
      { category: "finance", slug: "epf-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: K401_RULES.rulesLabel,
    rulesBannerFlag: "🇺🇸",
    related: [
      { category: "finance", slug: "paycheck-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: LEAVE_ENCASHMENT_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: CAGR_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "sip-calculator" },
      { category: "finance", slug: "fd-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: ADVANCE_TAX_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "income-tax-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: PT_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "income-tax-calculator" },
      { category: "finance", slug: "ctc-to-in-hand-salary" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: PAY_STUB_RULES.rulesLabel,
    related: [
      { category: "finance", slug: "paycheck-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: ROTH_COMPARE_RULES.rulesLabel,
    rulesBannerFlag: "🇺🇸",
    related: [
      { category: "finance", slug: "401k-calculator" },
      { category: "finance", slug: "paycheck-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: BONUS_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: ESI_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: SWP_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "sip-calculator" },
      { category: "finance", slug: "fd-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: DIVIDEND_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: GST_THRESHOLD_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
      { category: "finance", slug: "gst-calculator" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: HSA_RULES.rulesLabel,
    rulesBannerFlag: "🇺🇸",
    related: [
      { category: "finance", slug: "401k-calculator" },
      { category: "finance", slug: "401k-vs-roth-ira" },
  ...
  },
  {
    ...
    badge: "new",
    rulesBanner: RENT_RECEIPT_RULES.rulesLabel,
    rulesBannerFlag: "🇮🇳",
    related: [
...
export function searchTools(query: string) {
  ...
  return TOOLS.filter((item) => {
    const haystack = [item.name, item.shortDescription, item.category, item.status, ...item.keywords].join(" ").toLowerCase();
